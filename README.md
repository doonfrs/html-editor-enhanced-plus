# Flutter Html Editor - Enhanced - Plus
[![pub package](https://img.shields.io/pub/v/html_editor_enhanced_plus.svg)](https://pub.dev/packages/html_editor_enhanced_plus)
...
<table>
  ...
  <tr>
    <td><img alt="GIF example" src="https://raw.githubusercontent.com/tneotia/html-editor-enhanced/master/screenshots/html_editor_enhanced_plus.gif" width="250"/></td>
...
Add `html_editor_enhanced_plus: ^2.5.0` as dependency to your pubspec.yaml.
...
For the full API reference, see [here](https://pub.dev/documentation/html_editor_enhanced_plus/latest/).
...
Every callback is defined as a `Function(<parameters in some cases>)`. See the [documentation](https://pub.dev/documentation/html_editor_enhanced_plus/latest/) for more specific details on each callback.
...
```html
<script src="assets/packages/html_editor_enhanced_plus/assets/jquery.min.js"></script>
<link href="assets/packages/html_editor_enhanced_plus/assets/summernote-lite.min.css" rel="stylesheet">
<script src="assets/packages/html_editor_enhanced_plus/assets/summernote-lite.min.js"></script>
```
